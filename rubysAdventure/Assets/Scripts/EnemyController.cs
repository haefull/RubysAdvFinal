...
public class EnemyController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject rubyControllerObject = GameObject.FindWithTag("Player"); //this line of code finds the RubyController script by looking for a "RubyController" tag on Ruby
